...
#             endif
#         })
export def Select(title: string, items: list<any>, Callback: func(any, string) = null_function, Setup: func(number) = null_function, close_on_bs: bool = false)
...
# nnoremap <leader>l <ScriptCmd>Select('TestSelect', ['first', 'second'])<CR>
nnoremap <leader>l <ScriptCmd>Commands([ {text: "Quickfix"}, {text: "Next", key: "j", cmd: "cnext"}, {text: "Prev", key: "k", cmd: "cprev"}, {text: "Location"}, {text: "Next", key: ".", cmd: "lnext"}, {text: "Prev", key: ",", cmd: "lprev"}, ])<CR>
