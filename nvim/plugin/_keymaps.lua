...
vim.keymap.set('n', '<C-f>', require('features/globalfind').Grep)
vim.keymap.set('v', '<C-f>', require('features/globalfind').Grep)
vim.keymap.set('n', '<C-f><C-t>', require('features/globalfind').filterTestEntries)
